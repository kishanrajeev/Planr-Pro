...
class _HomePageState extends State<HomePage> {
  ...
  void _addClass() {
    if (_classes3.length < 100) {
      setState(() {
        _classes3.add(_classController.text);
      });
      _saveclasses3();
    }
  ...
  void _deleteClass(int index) {
    setState(() {
      _classes3.removeAt(index);
    });
    _saveclasses3();
  }

  void _saveclasses3() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    prefs.setStringList("classes3", _classes3);
  }

  void _loadclasses3() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    List<String> savedclasses3 = prefs.getStringList("classes3") ?? [];
    setState(() {
      _classes3 = savedclasses3;
    });
  }
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child: TextField(
              controller: _classController,
              decoration: InputDecoration(hintText: "Enter What's Due"),
            ),
          ),
          Container(
            ...
            child: ReorderableListView.builder(
              ...
              onReorder: (oldIndex, newIndex) {
                setState(() {
                  ...
                  final item = _classes3.removeAt(oldIndex);
                  _classes3.insert(newIndex, item);
                });
              },
            ),
          ),
